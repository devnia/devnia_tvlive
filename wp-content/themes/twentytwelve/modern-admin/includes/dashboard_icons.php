    ...
    <form action="" method="post">
        ...
        <div class="clearfix">
            <table id="mordern-admin-icons-table" class="modern-table-left form-table" >
                <tbody>
                <tr valign="top">
                    <td scope="row" class="mordern-admin-dashboard-icon-show">Show</td>
                    <td>Name</td>
                    <td>Icon</td>
                </tr>
                <?php
                ...
                foreach($dw as $key){
                    ...
                    <tr valign="top">
                        ...
                        <td scope="row" class="mordern-admin-dashboard-icon-show"><input type="checkbox" value="1" name="dashboard_icons[<?php echo strip_tags($key);?>][show]" <?php checked($show,1);?>></td>
