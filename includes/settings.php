    ...
    <form action="" method="post">
        ...
        <table class="modern-admin-form form-table">
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" class="regular-text" id="admin_logo_image" value="<?php echo $admin_logo_image;?>" name="settings[admin_logo_image]">
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" class="regular-text" id="admin_logo_url" value="<?php echo $admin_logo_url;?>" name="settings[admin_logo_url]">
        ...
        <table class="modern-admin-form form-table">
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" class="regular-text" id="admin_footer_text"  value="<?php echo $admin_footer_text;?>" name="settings[admin_footer_text]">
                </td>
